    ...
    return (
        <nav className="h-[10vh] bg-[#0F0F0F] border-gray-200 dark:border-gray-600 dark:bg-gray-900">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-[9px]">
                ...
                <div id="mega-menu-full" className={`${isMenuOpen ? 'flex' : 'hidden'} items-center justify-between font-medium w-full md:flex md:w-auto z-40 bg-black md:bg-[#0F0F0F]`}>
                    <ul className="text-[#fffce1c7] flex flex-col p-4 md:p-0 mt-4 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:dark:bg-[#0F0F0F] dark:border-gray-700">
                        <li>
                            <a href="/" className="block py-2 px-3 rounded  md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Home</a>
                        </li>
                        ...
                        <li>
                            <a href="/Pratice" className="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Pratice</a>
                        </li>
                        <li>
